...
public class HelloWorldServer {
  ...
  private class GreeterImpl extends GreeterGrpc.GreeterImplBase {
    ...
    // @Override
    // public void computeAdd(AddRequest req, StreamObserver<AddReply> responseObserver) {
    //   // Generate another greeting message for the new method.

    //   AddReply reply = AddReply.newBuilder().setMessage("Hello again " + req.getName()).build();
